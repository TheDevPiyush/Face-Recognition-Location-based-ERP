...
export default function HomeScreen() {
  ...
  const fetchDashboard = useCallback(async () => {
    try {
      ...
      const [analyticsRes, subjectsRes] = await Promise.all([
        apiService.getAttendanceAnalytics({ month, ...(batchId != null && { batch_id: batchId }) }),
        apiService.getSubjects(),
      ]);

      setUser(me);
      setAttendancePercent(
        analyticsRes.monthly_percentage?.percentage ?? analyticsRes.summary.overall_percentage ?? null
      );
      setSubjects(
        batchId != null ? subjectsRes.filter((s) => s.batch === batchId) : subjectsRes
      );
    } catch (e) {
  ...
  const batchLabel = user?.batch?.name ?? user?.batch?.code ?? '—';
      ...
      >
          ...
          <View style={styles.ctaInner}>
            ...
            <View style={styles.ctaTextWrap}>
              {user?.role === 'student' ?
                ...
                :
                <Text style={styles.ctaTitle}>Attendance Window</Text>}
            </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.announcementPlaceholder}>
            ...
            <Text style={styles.announcementEmpty}>No announcements yet</Text>
          </View>
        </View>
      </ScrollView>
    </View>
